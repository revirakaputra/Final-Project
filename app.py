...
def run_ml_app():
    ...
    GenHlth = left.number_input('General Health (Scale 1-5)', min_value=1, max_value=5)
    BMI = right.number_input('Body Mass Index (Scale 15-45)', min_value=15, max_value=45)
